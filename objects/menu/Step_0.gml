...
if(keyboard_check_pressed(ord("N"))&&kk = 0){
	a = instance_create_depth(0,0,0,battle_effect);
	a.mode = 0;
	if(kk = 0){
		kk = 1;
	}
}
if(keyboard_check_pressed(ord("I"))&&kk = 0){
	a = instance_create_depth(0,0,0,battle_effect);
	a.mode = 1;
	if(kk = 0){
		kk = 1;
...
if(keyboard_check_pressed(ord("K"))&&kk = 0){
	a = instance_create_depth(0,0,0,battle_effect);
	a.mode = 2;
	if(kk = 0){
		kk = 1;
...
if(keyboard_check_pressed(ord("H"))&&kk = 0){
	a = instance_create_depth(0,0,0,battle_effect);
	a.mode = 3;
	if(kk = 0){
		kk = 1;
