if(bar_visible&&damage>0){
	...
	draw_rectangle_color(xstart-bar_width/2-1,ystart+18,xstart+bar_width/2-1,ystart+30,c_black,c_black,c_black,c_black,1);
}

if(damage<=0){
	if(damage = -1)draw_sprite_ext(spr_battle_damage_miss,1,xstart,y,1,1,0,c_gray,1);
	if(damage = -2)draw_sprite_ext(spr_battle_damage_miss,0,xstart,y,1,1,0,c_gray,1);
}else{
