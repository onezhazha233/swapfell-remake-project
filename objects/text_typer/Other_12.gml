...
switch(cmd[|0]){
	...
	case "pap":
		battle_enemy_papyrus._head_image=cmd[|1];
		break;
		
	case "color_rgb":
		_color_text[0]=make_color_rgb(ds_list_find_value(cmd,1),ds_list_find_value(cmd,2),ds_list_find_value(cmd,3));
		_color_text[1]=make_color_rgb(ds_list_find_value(cmd,1),ds_list_find_value(cmd,2),ds_list_find_value(cmd,3));
		_color_text[2]=make_color_rgb(ds_list_find_value(cmd,1),ds_list_find_value(cmd,2),ds_list_find_value(cmd,3));
		_color_text[3]=make_color_rgb(ds_list_find_value(cmd,1),ds_list_find_value(cmd,2),ds_list_find_value(cmd,3));
		break;
		
	case "eye_y":
		battle_enemy_papyrus.purple_eye_y=cmd[|1];
		break;
