...
if(Language() = 0){
	a.text = "as you can see,{sleep 20}&i destroyed your&MERCY,{sleep 20}{clear}though&you have never&used it before.{pause}{clear}in the same way,{sleep 20}&you destroyed his.";
}
else{
